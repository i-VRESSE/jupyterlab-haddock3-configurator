...
1. use the search functionality [here](https://github.com/i-VRESSE/jupyterlab-haddock3-configurator/issues) to see if someone already filed the same issue;
...
1. install see [README.md#Contributing](README.md#Contributing)
1. make sure linter is happy with `jlpm lint`;
...
In case you feel like you've made a valuable contribution, but you don't know how to write or run tests for it, or how to generate the documentation: don't let this discourage you from making the pull request; we can help you! Just go ahead and submit the pull request, but keep in mind that you might be asked to append additional commits to your pull request (have a look at some of our old pull requests to see how this works, for example [#1](https://github.com/i-VRESSE/jupyterlab-haddock3-configurator/pull/1)).
...
3. Goto https://github.com/i-VRESSE/jupyterlab-haddock3-configurator/releases/new
